    ...
    static class Line {
        ...
        public boolean isValid() {
            ...
            if (password.contains(letter)) {
                try {
                    if ((password.charAt(low - 1) == letter.charAt(0) && password.charAt(hight - 1) != letter.charAt(0)) 
                        || (password.charAt(low - 1) != letter.charAt(0) && password.charAt(hight - 1) == letter.charAt(0))) {
                        res = true;
                    }
